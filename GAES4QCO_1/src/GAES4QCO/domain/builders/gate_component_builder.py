...
from GAES4QCO_1.src.GAES4QCO.domain.models.circuit.gate_component import GateComponent
from GAES4QCO_1.src.GAES4QCO.domain.models.circuit.step_size import StepSize
from src.GAES4QCO.domain.builders.step_size_builder import StepSizeBuilder
...
class GateBuilder:
    ...
    def __init__(self, step_size_builder: StepSizeBuilder, evolutionary_strategies: bool = True):
        # O mapa é um detalhe de implementação da fábrica.
        pass


    def build_gate_component(self, qubits: List[int], evolutionary_strategies: bool = True) -> Tuple[GateComponent, list[int]]:
        ...
        gate_component = GateComponent(gate_class=gate_class, qubits=chosen_qubits,
                                       parameters=generated_angles, steps_sizes=step_size, extra_controls=extra_controls, is_inverse=is_inverse)
        free_qubits = list(set(qubits) - set(chosen_qubits))
